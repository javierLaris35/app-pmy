...
export const allowedPageRoles = {
    ...
    bodega: {
        ...
        entrada: [UserRoleEnum.ADMIN, UserRoleEnum.SUPERADMIN, UserRoleEnum.SUBADMIN],
        ...
        salida: [UserRoleEnum.ADMIN, UserRoleEnum.SUPERADMIN, UserRoleEnum.SUBADMIN]
    },
    operaciones: {
        ...
        traslados: [UserRoleEnum.ADMIN, UserRoleEnum.SUBADMIN, UserRoleEnum.SUPERADMIN, UserRoleEnum.USER, UserRoleEnum.BODEGA, UserRoleEnum.AUXILIAR],
    ...
    finanzas: {
        ...
        consolidador: [UserRoleEnum.ADMIN, UserRoleEnum.SUBADMIN, UserRoleEnum.SUPERADMIN, UserRoleEnum.AUXILIAR],
