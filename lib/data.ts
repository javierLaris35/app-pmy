...
export interface PackageData {
  guia: string
  status: "Devolución pendiente" | "Pick Up" | "Entregado" | "En ruta"
  destinatario: string
  direccion: string
  ciudad: string
  sucursal: string
...
export const mockPackages: PackageData[] = [
  ...
  },
  {
    guia: "391158900267",
    status: "Devolución pendiente",
    destinatario: "María López Hernández",
    direccion: "Av. Obregón #456",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391158897164",
    status: "Devolución pendiente",
    destinatario: "Carlos Rodríguez Sánchez",
  ...
  },
  {
    guia: "391152739002",
    status: "Devolución pendiente",
    destinatario: "Ana Martínez López",
    direccion: "Av. Tecnológico #234",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "390959919727",
    status: "Devolución pendiente",
    destinatario: "Luis García Morales",
  ...
  },
  {
    guia: "391145749321",
    status: "Devolución pendiente",
    destinatario: "Rosa Hernández Silva",
  ...
  },
  {
    guia: "391076848427",
    status: "Devolución pendiente",
    destinatario: "Pedro Sánchez Ruiz",
  ...
  },
  {
    guia: "391156366467",
    status: "Devolución pendiente",
    destinatario: "Carmen López García",
  ...
  },
  {
    guia: "391074887156",
    status: "Devolución pendiente",
    destinatario: "Miguel Rodríguez Pérez",
  ...
  },
  {
    guia: "391152192382",
    status: "Devolución pendiente",
    destinatario: "Elena Martínez Hernández",
    direccion: "Av. Constitución #234",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  ...
  // Pick Up
  {
    guia: "391152232129",
    status: "Pick Up",
    destinatario: "Roberto García López",
    direccion: "Calle Zaragoza #567",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391119318840",
    status: "Pick Up",
    destinatario: "Patricia Hernández Ruiz",
    direccion: "Av. Reforma #890",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391154372920",
    status: "Pick Up",
    destinatario: "Fernando Sánchez García",
    direccion: "Calle Guerrero #123",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391178114712",
    status: "Pick Up",
    destinatario: "Guadalupe López Martínez",
    direccion: "Av. Madero #456",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "390938612027",
    status: "Pick Up",
    destinatario: "Alejandro Rodríguez Hernández",
    direccion: "Calle Victoria #789",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391115272264",
    status: "Pick Up",
    destinatario: "Silvia Martínez Sánchez",
    direccion: "Av. Libertad #234",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391149887673",
    status: "Pick Up",
    destinatario: "Jorge García Rodríguez",
    direccion: "Calle Progreso #567",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "390962270148",
    status: "Pick Up",
    destinatario: "Mónica Hernández López",
    direccion: "Av. Esperanza #890",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391174640876",
    status: "Pick Up",
    destinatario: "Ricardo Sánchez Martínez",
    direccion: "Calle Paz #123",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391169872812",
    status: "Pick Up",
    destinatario: "Verónica López Hernández",
    direccion: "Av. Unión #456",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391153474436",
    status: "Pick Up",
    destinatario: "Arturo García Sánchez",
    direccion: "Calle Trabajo #789",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391159596800",
    status: "Pick Up",
    destinatario: "Leticia Martínez Rodríguez",
    direccion: "Av. Fraternidad #234",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391011740390",
    status: "Pick Up",
    destinatario: "Raúl Hernández García",
    direccion: "Calle Solidaridad #567",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391082646137",
    status: "Pick Up",
    destinatario: "Claudia Sánchez López",
    direccion: "Av. Justicia #890",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "882900723279",
    status: "Pick Up",
    destinatario: "Sergio López Martínez",
    direccion: "Calle Democracia #123",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },

  // Otros status para variedad
  {
    guia: "391190194412",
    status: "Entregado",
    destinatario: "Isabel García Hernández",
    direccion: "Av. República #456",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391156261543",
    status: "En ruta",
    destinatario: "Tomás Rodríguez Sánchez",
    direccion: "Calle Patria #789",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "882900325395",
    status: "En ruta",
    destinatario: "Norma Martínez García",
    direccion: "Av. Nación #234",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391159151424",
    status: "Entregado",
    destinatario: "Óscar Hernández López",
    direccion: "Calle Pueblo #567",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
  {
    guia: "391145686264",
    status: "En ruta",
    destinatario: "Beatriz Sánchez Rodríguez",
    direccion: "Av. Ciudadanía #890",
    ciudad: "Navojoa",
    sucursal: "NAV",
    fecha: "2025-01-21",
  },
